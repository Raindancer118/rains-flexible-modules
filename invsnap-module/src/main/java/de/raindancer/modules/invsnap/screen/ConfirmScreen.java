...
/**
 * "Are you sure?" — Core's dialog, under this module's name. See {@code mannequin-module}'s copy
 * of this same two-line wrapper for why it exists at all: the page is {@code ConfirmMenu}'s,
 * always, and this only gives call sites a name in this package and gives {@code ScreenGrammarTest}
 * something to look for when it checks that every {@code danger(} button confirms.
 */
public final class ConfirmScreen extends ConfirmMenu implements IInvSnapScreen {
