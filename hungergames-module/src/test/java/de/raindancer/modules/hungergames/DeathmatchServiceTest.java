...
class DeathmatchServiceTest {
    ...
    private static HungerGamesSettings rebuild(HungerGamesSettings s, boolean manualOnly) {
        return new HungerGamesSettings(
                ...
                s.grapplingRange(), s.grapplingPower(), s.grapplingCooldownSeconds(), s.repulseRadius(), s.repulseStrength(),
                s.repulseSlowSeconds(), s.repulseAffectMobs(), s.repulseCooldownSeconds(), s.feastGoldenApples(), s.warKitMaterial(),
                s.leapPower(), s.leapCooldownSeconds(), s.exmatrikulatorDuration(), s.exmatrikulatorRadius(),
