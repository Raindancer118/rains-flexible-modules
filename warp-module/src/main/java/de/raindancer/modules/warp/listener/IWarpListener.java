 ...
 * {@code WarpServices} rather than reaching for anything.
 *
 ...
 * is not told grows by an entry per player who has ever been on the server. That has already
 * happened twice in this repository, which is why it is a method that cannot be omitted quietly
 * rather than a paragraph in a readme.
 */
public interface IWarpListener extends Listener {
