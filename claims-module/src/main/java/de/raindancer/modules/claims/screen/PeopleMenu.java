...
/** Everyone who has anything to do with this claim: the trusted, the public, and the barred. */
public final class PeopleMenu extends ClaimScreen {

    public PeopleMenu(ClaimServices services, org.bukkit.entity.Player viewer, Claim claim, Menu parent) {
        super(services, viewer, claim, parent);
    }

    @Override
    protected Component title() {
        return Component.text("People — " + claim().name());
    }

    @Override
    protected List<String> helpLines() {
        return List.of("<gray>Three questions about people, in the order they come up:",
                "",
                "<white>Trusted</white> <dark_gray>·</dark_gray> <gray>the ones you named",
                "<white>Everybody else</white> <dark_gray>·</dark_gray> <gray>what a stranger may do",
                "<white>Kept out</white> <dark_gray>·</dark_gray> <gray>the ones who may not return");
    }
