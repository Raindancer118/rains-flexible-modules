 ...
 * module's context so it is unregistered again when the module stops, and holding {@code HomeServices}
 ...
 * twice in this repository, which is why it is a method that cannot be omitted quietly rather than a
 * paragraph in a readme.
 */
public interface IHomeListener extends Listener {
