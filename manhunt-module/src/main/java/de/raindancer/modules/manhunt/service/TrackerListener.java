...
public final class TrackerListener implements Listener {
     ...
     *
     * <p>Not gated on a hunt running, and not on the dead player being a Hunter: this strips the
     * module's own item and nothing else, so the rule is the simpler "ours never drops, ever" rather
     * than one that has to be right about the moment as well.
     */
