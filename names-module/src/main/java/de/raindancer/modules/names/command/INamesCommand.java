 ...
 * Typing it is faster than clicking, or it takes an argument a menu cannot ask for, or nothing else
 * reaches it. This module has exactly one, and it earns its place under the third clause: none of its
 * recipes is a Bukkit recipe, so without this the whole feature is undiscoverable.
 */
public interface INamesCommand extends BasicCommand {
